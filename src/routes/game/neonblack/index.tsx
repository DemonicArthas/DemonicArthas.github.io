  ...
  return (
    <div class="bg-base-200 p-2">
      <article class="prose p-4 lg:prose-lg">
	  	<h2>Neon Black</h2>
		<p>3D stealth-action platformer. Avoid the gaze of "The Boss", take down guards and collect various usable items to aid you in your quest.</p>
        ...
        <video width="1024" height="768" controls muted>
          <source src="/games/gamejams/NeonBlack.mp4" type="video/mp4" />
